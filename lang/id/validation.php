...
return [
    ...
    'required_without_all' => ':Attribute wajib diisi saat :values tidak tersedia.',
    ...
    'attributes' => [
        ...
        'sender_phone' => 'No. telepon pengirim',
        'receiver_name' => 'Nama penerima',
        'receiver_phone' => 'No. telepon penerima',
        'tracking_number' => 'No. tracking',
        'zone_id' => 'Zona tujuan',
        'weight_estimated' => 'Estimasi berat',
        'length_estimated' => 'Estimasi panjang',
        'width_estimated' => 'Estimasi lebar',
        'height_estimated' => 'Estimasi tinggi',
        'weight_actual' => 'Berat aktual',
        'length_actual' => 'Panjang aktual',
        'width_actual' => 'Lebar aktual',
        'height_actual' => 'Tinggi aktual',
        'delivery_fee' => 'Biaya antar lokal',
        'shipping_price' => 'Harga kirim',
        'is_central' => 'Zona pusat',
