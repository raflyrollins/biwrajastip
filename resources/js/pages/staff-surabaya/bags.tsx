...
interface StaffBagsProps {
    bags: PaginatedData;
}

export default function StaffBags({ bags }: StaffBagsProps) {
    return (
        <>
            <Head title="Bag - Staff Surabaya" />
                                    ...
                                    {bags.data.length === 0 ? (
                                        <tr>
                                            ...
                                            >
                                                <EmptyState
                                                    title="Belum Ada Bag"
                                                    description="Bag akan dibuat melalui aplikasi mobile."
                                                    icon={
