...
interface StaffBatchesProps {
    batches: PaginatedData;
}

export default function StaffBatches({ batches }: StaffBatchesProps) {
    return (
        <>
            <Head title="Batch - Staff Surabaya" />
                    ...
                    >
                        <div>
                            ...
                            <p className="mt-1 text-sm text-[var(--body-subtle)]">
                                Daftar batch pengiriman dari Surabaya ke Ende.
                            </p>
                        </div>
                    </motion.div>
                                        ...
                                        <tr>
                                            ...
                                            >
                                                <EmptyState
                                                    ...
                                                    description="Batch akan dibuat melalui aplikasi mobile."
                                                    icon={
